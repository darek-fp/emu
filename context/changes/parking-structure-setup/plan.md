...
- [ ] 2.1 POST /api/admin/sectors creates sectors and persists to database
- [ ] 2.2 GET /api/admin/sectors returns current sectors
- [ ] 2.3 Supabase RLS policies enforce admin-only access
- [ ] 2.4 Type checking passes
- [ ] 2.5 Linting passes

#### Manual

- [ ] 2.6 Admin submits batch changes and sees them reflected immediately
- [ ] 2.7 Atomic validation: partial batch failures reject entire batch
- [ ] 2.8 Error messages are clear and actionable
